...
export default function Home() {
	return (
		<section
			className={`w-full h-auto bg-base-100 rounded-md shadow-lg shadow-black/30 p-5 flex justify-start items-start flex-col gap-3`}
		>
			<HeaderComponent title="About Us" />
			<p className={`w-full h-auto text-sm font-mandali`}>
				I am <span className={`text-primary`}>Pawan Kumar</span>, a passionate <span className="text-primary">Full stack developer</span>, driven by
				the art of creating seamless digital experiences. With
